...
class ChangeNdBuildingFinishedListViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('DROP VIEW IF EXISTS nd_building_finished_list_view');
        
        DB::statement("
            CREATE VIEW nd_building_finished_list_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
                ...
                FROM `nd_buys`
                    ...
                    JOIN nd_buy_origins ON nd_buy_origins.nd_origins_id = 1
