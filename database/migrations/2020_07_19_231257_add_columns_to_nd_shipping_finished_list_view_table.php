...
class AddColumnsToNdShippingFinishedListViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('DROP VIEW IF EXISTS nd_shipping_finished_list_view');
        
        DB::statement("
            CREATE VIEW nd_shipping_finished_list_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
