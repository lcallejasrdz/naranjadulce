...
class AddColumnsToNdDeliveryDetailViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('DROP VIEW IF EXISTS nd_delivery_detail_view');
        
        DB::statement("
            CREATE VIEW nd_delivery_detail_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
