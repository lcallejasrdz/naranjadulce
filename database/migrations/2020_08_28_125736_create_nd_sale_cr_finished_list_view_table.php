...
class CreateNdSaleCrFinishedListViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
            CREATE VIEW nd_sale_cr_finished_list_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
    ...
    {
        DB::statement('DROP VIEW IF EXISTS nd_sale_cr_finished_list_view');
    }
}
