...
class CreateNdBuildingCrFinishedListViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
            CREATE VIEW nd_building_cr_finished_list_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
                ...
                FROM `nd_buys`
                    ...
                    JOIN nd_buy_origins ON nd_buy_origins.nd_origins_id = 2
                    AND nd_buy_origins.nd_buys_id = nd_buys.id
    ...
    {
        DB::statement('DROP VIEW IF EXISTS nd_building_cr_finished_list_view');
    }
}
