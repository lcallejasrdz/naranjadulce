...
class ChangeNdSaleFinishedListViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('DROP VIEW IF EXISTS nd_sale_finished_list_view');
        
        DB::statement("
            CREATE VIEW nd_sale_finished_list_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
