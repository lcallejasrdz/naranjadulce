...
class CreateNDDeliveryConfirmViewsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
            CREATE VIEW nd_delivery_confirm_view AS
                SELECT
                    nd_buys.id,
                    nd_buys.slug,
                ...
                FROM `nd_buys`
                    ...
                    JOIN nd_shippings ON nd_shippings.nd_buys_id = nd_buys.id

                WHERE nd_buys.nd_status_id = 6
    ...
    {
        DB::statement('DROP VIEW IF EXISTS nd_delivery_confirm_view');
    }
}
