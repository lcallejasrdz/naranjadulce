	...
	<tbody>
		...
		@foreach($item as $column => $value)
			...
			@elseif($column == 'preferential_schedule')
		        ...
		        @endif
			@elseif($column != 'last_login' && $column != 'created_at' && $column != 'updated_at' && $column != 'deleted_at' && $column != 'slug' && $value != '')
	            <tr>
	                <th>
	                    {{ ucfirst(trans('validation.attributes.'.$column)) }}
	                </th>
...
<input type="hidden" value="1" id="verified_building" name="verified_building">