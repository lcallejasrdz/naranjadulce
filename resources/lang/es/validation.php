...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'nd_delivery_schedules_id' => 'horario de entrega',
        'schedule_id'           => 'horario de entrega',
        'observations'          => '¿Alguna observación?',
        'how_know_us'           => '¿Por qué medio te enteraste de nosotros?',
        'nd_contact_means_id'   => '¿Por qué medio te enteraste de nosotros?',
        'how_know_us_other'     => 'especifica por que medio te enteraste de nosotros',
        'contact_mean_other'    => 'especifica por que medio te enteraste de nosotros',
        'address_references'    => 'referencias',
        'references'            => 'referencias',
        'address_type'          => 'tipo de domicilio',
        'nd_address_types_id'   => 'tipo de domicilio',
        'parking'               => '¿Cuénta con estacionamiento?',
        'nd_parkings_id'        => '¿Cuénta con estacionamiento?',
        'who_sends'             => '¿Quién envía?',
        'who_receives'          => '¿Quién recibe?',
        'status_id'             => 'estatus',
        'nd_status_id'          => 'estatus',
